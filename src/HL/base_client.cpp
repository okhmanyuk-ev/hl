...
void BaseClient::readConnectionlessChallenge(Network::Packet& packet)
{
	...
	auto challenge = Console::System::MakeTokensFromString(sky::bitbuffer_helpers::ReadString(packet.buf))[1];
	...
	sky::bitbuffer_helpers::WriteString(pack.buf, ss);
...
void BaseClient::readRegularMessages(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularGameMessage(sky::BitBuffer& msg, uint8_t index)
{
...
void BaseClient::receiveFile(std::string_view fileName, sky::BitBuffer& msg)
{
...
void BaseClient::readRegularDisconnect(sky::BitBuffer& msg)
{
	auto reason = sky::bitbuffer_helpers::ReadString(msg);
	disconnect(reason);
}

void BaseClient::readRegularEvent(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularVersion(sky::BitBuffer& msg)
{
	auto version = msg.read<int32_t>();
}

void BaseClient::readRegularSetView(sky::BitBuffer& msg)
{
	int16_t value = msg.read<int16_t>();
}

void BaseClient::readRegularSound(sky::BitBuffer& msg)
{
	...
	sky::bitbuffer_helpers::ReadBitVec3(msg, sound.origin);
...
void BaseClient::readRegularTime(sky::BitBuffer& msg)
{
	mTime = msg.read<float>();
}

void BaseClient::readRegularPrint(sky::BitBuffer& msg)
{
	auto text = sky::bitbuffer_helpers::ReadString(msg);
	sky::Log(text);
}

void BaseClient::readRegularStuffText(sky::BitBuffer& msg)
{
	auto text = sky::bitbuffer_helpers::ReadString(msg);
...
void BaseClient::readRegularAngle(sky::BitBuffer& msg)
{
	float x = sky::bitbuffer_helpers::ReadHiResAngle(msg);
	float y = sky::bitbuffer_helpers::ReadHiResAngle(msg);
	float z = sky::bitbuffer_helpers::ReadHiResAngle(msg);
}

void BaseClient::readRegularServerInfo(sky::BitBuffer& msg)
{
	...
	server_info.crc = sky::bitbuffer_helpers::ReadBytesToString(msg, 16);
	...
	server_info.game_dir = sky::bitbuffer_helpers::ReadString(msg);
	server_info.hostname = sky::bitbuffer_helpers::ReadString(msg);
	server_info.map = sky::bitbuffer_helpers::ReadString(msg);
	server_info.map_list = sky::bitbuffer_helpers::ReadString(msg);
...
void BaseClient::readRegularLightStyle(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
	...
	m_LightStyles[index] = sky::bitbuffer_helpers::ReadString(msg);
}

void BaseClient::readRegularUserInfo(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
	auto userid = msg.read<int32_t>();
	auto info = sky::bitbuffer_helpers::ReadString(msg);
	uint8_t hash[16];
	msg.read(&hash, 16);
...
void BaseClient::readRegularDeltaDescription(sky::BitBuffer& msg)
{
	auto name = sky::bitbuffer_helpers::ReadString(msg);
	auto fieldsCount = msg.readBits(16);
	mDelta.add(msg, name, fieldsCount);
	msg.alignByteBoundary();
}

void BaseClient::readRegularClientData(sky::BitBuffer& msg)
{
	if (mHLTV)
		return;
...
void BaseClient::readRegularPings(sky::BitBuffer& msg)
{
	while (msg.readBit())
	{
...
void BaseClient::readRegularEventReliable(sky::BitBuffer& msg)
{
	Protocol::Event evt;
...
void BaseClient::readRegularSpawnBaseline(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularTempEntity(sky::BitBuffer& msg)
{
	...
	default:
		...
		if (length == -1)
		{
			...
			else if (type == Protocol::TempEntity::TextMessage)
			{
				...
				msg.seek(14);
				sky::bitbuffer_helpers::ReadString(msg);
			}
		}
		else
		{
...
void BaseClient::readRegularSignonNum(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularStaticSound(sky::BitBuffer& msg)
{
	Protocol::Sound sound;

	sound.origin[0] = sky::bitbuffer_helpers::ReadCoord(msg);
	sound.origin[1] = sky::bitbuffer_helpers::ReadCoord(msg);
	sound.origin[2] = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readRegularCDTrack(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
	auto loop = msg.read<uint8_t>();
}

void BaseClient::readRegularWeaponAnim(sky::BitBuffer& msg)
{
	auto seq = msg.read<uint8_t>();
	auto group = msg.read<uint8_t>();
}

void BaseClient::readRegularDecalName(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
	auto name = sky::bitbuffer_helpers::ReadString(msg);
...
void BaseClient::readRegularRoomType(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularUserMsg(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
...
void BaseClient::readRegularPacketEntities(sky::BitBuffer& msg, bool delta)
{
	if (mSignonNum == 1)
	{
		signon(2);
...
void BaseClient::readRegularResourceList(sky::BitBuffer& msg)
{
	...
	for (auto& resource : mResources)
	{
		...
		resource.name = sky::bitbuffer_helpers::ReadString(msg);
...
void BaseClient::readRegularMoveVars(sky::BitBuffer& msg)
{
	...
	movevars.sky_name = sky::bitbuffer_helpers::ReadString(msg);

	mMoveVars = movevars;
}

void BaseClient::readRegularResourceRequest(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularCustomization(sky::BitBuffer& msg)
{
	auto index = msg.read<uint8_t>();
...
void BaseClient::readFileTxferFailed(sky::BitBuffer& msg)
{
	auto name = sky::bitbuffer_helpers::ReadString(msg);
	sky::Log(Console::Color::Red, "failed to download file: " + name);
}

void BaseClient::readRegularHLTV(sky::BitBuffer& msg)
{
	sky::Log(Console::Color::Red, "SVC_HLTV was received");
}

void BaseClient::readRegularDirector(sky::BitBuffer& msg)
{
...
void BaseClient::readRegularVoiceInit(sky::BitBuffer& msg)
{
	auto codec = sky::bitbuffer_helpers::ReadString(msg);
	auto quality = msg.read<uint8_t>(); // if protocol > 46

	Utils::dlog("codec: \"{}\", quality: {}", codec, quality);
}

void BaseClient::readRegularSendExtraInfo(sky::BitBuffer& msg)
{
	auto fallbackDir = sky::bitbuffer_helpers::ReadString(msg);
	auto allowCheats = msg.read<uint8_t>();
}

void BaseClient::readRegularResourceLocation(sky::BitBuffer& msg)
{
	auto downloadUrl = sky::bitbuffer_helpers::ReadString(msg);
}

void BaseClient::readRegularCVarValue(sky::BitBuffer& msg)
{
	auto name = sky::bitbuffer_helpers::ReadString(msg);
	sky::Log(Console::Color::Red, "SVC_SENDCVARVALUE: " + name);
}

void BaseClient::readRegularCVarValue2(sky::BitBuffer& msg)
{
...
void BaseClient::readTempEntityBeamPoints(sky::BitBuffer& msg)
{
	glm::vec3 start;
	start.x = sky::bitbuffer_helpers::ReadCoord(msg);
	start.y = sky::bitbuffer_helpers::ReadCoord(msg);
	start.z = sky::bitbuffer_helpers::ReadCoord(msg);

	glm::vec3 end;
	end.x = sky::bitbuffer_helpers::ReadCoord(msg);
	end.y = sky::bitbuffer_helpers::ReadCoord(msg);
	end.z = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntityExplosion(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.z = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntitySmoke(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntitySparks(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntityGlowSprite(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntitySprite(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
...
void BaseClient::readTempEntityBloodSprite(sky::BitBuffer& msg)
{
	glm::vec3 origin;
	origin.x = sky::bitbuffer_helpers::ReadCoord(msg);
	origin.y = sky::bitbuffer_helpers::ReadCoord(msg);
...
#pragma region write
void BaseClient::writeRegularMessages(sky::BitBuffer& msg)
{
...
void BaseClient::writeRegularMove(sky::BitBuffer& msg)
{
...
void BaseClient::writeRegularDelta(sky::BitBuffer& msg)
{
	msg.write<uint8_t>((uint8_t)Protocol::Client::Message::Delta);
	msg.write<uint8_t>(mDeltaSequence);
}

void BaseClient::writeRegularFileConsistency(sky::BitBuffer& msg)
{
	size_t o = msg.getSize();
...
void BaseClient::sendCommand(const std::string& command)
{
	...
	sky::bitbuffer_helpers::WriteString(buf, command);
...
void BaseClient::initializeConnection()
{
	...
	sky::bitbuffer_helpers::WriteString(packet.buf, "getchallenge steam");
